...
bot = Bot(token='6256670865:AAFKIFTsED4Dcc68pemJXMzLcVeeRmCjH50')
dp = Dispatcher(bot)

# Замените 'CHANNEL_ID' на ID вашего канала
channel_id = -1001911305804  # Уберите знак "-" перед ID, если у вас приватный канал
...
async def send_new_data():
    ...
    try:
        with open('Sites/parsering.json', 'r', encoding='utf-8') as file:
            data = json.load(file)
...
def execute_jsons_files():
    ...
    try:
        ...
        parser_1.main()  # Вызов функции main из jsons_files.py.
    except Exception as e:
